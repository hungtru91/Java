					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active">Danh sách các bộ
									phim</li>
							</ol>
						</div>
					</div>
						...
						<div class="col-sm-3">
							<div class="list-group movie-list">
								<c:forEach var="movie" items="${movies}">
									<a data-movie-id="${movie.id}" class="list-group-item"
										href="javascript:void(0);" style="margin-top: 5px">${movie.name}</a>
								</c:forEach>
							</div>
						</div>
						<div class="col-sm-9">
